...
const { RESTAURANT_UI_EXAMPLES } = require('./a2ui_examples');
...
if (require.main === module) {
    const my_base_url = "http://localhost:8000";
    ...
    const restaurant_prompt = get_ui_prompt(my_base_url, RESTAURANT_UI_EXAMPLES);

    console.log(restaurant_prompt);

    // This demonstrates how you could save the prompt to a file for inspection
    const fs = require('fs');
    try {
        fs.writeFileSync("generated_prompt.txt", restaurant_prompt);
